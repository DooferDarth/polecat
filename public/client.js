...
const loginHTML = `<main class="login container">
  ...
  <div class="row">
    <div class="col-12 col-6-tablet push-3-tablet col-4-desktop push-4-desktop">
      <form class="form">
        <a class="button" href="/oauth/discord">
          <img style="width: 20px; height: 20px;" src="Discord-Logo-Color.svg" alt="" />
...
const signupHTML = `<main class="login container">
  ...
  <div class="row">
    <div class="col-12 col-6-tablet push-3-tablet col-4-desktop push-4-desktop">
      <form class="form">
        <fieldset>
          <input class="block" type="text" name="username" placeholder="username">
          <input class="block" type="email" name="email" placeholder="email">
          <input class="block" type="text" name="discord" placeholder="discord" disabled>
        </fieldset>
...
const showSignup = async () => {
    ...
    // document.getElementById('discord').value = `${profile.username}#${profile.discriminator}`;
};
